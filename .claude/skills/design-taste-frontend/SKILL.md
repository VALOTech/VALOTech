...
description: Anti-slop frontend skill for marketing surfaces. Use for landing pages, public homepages, pricing/marketing pages, portfolios, and redesigns of those. NOT for dashboards, data tables, or multi-step product/admin UI. The agent reads the brief, infers the right design direction, and ships interfaces that do not look templated. Real design systems when applicable, audit-first on redesigns, strict pre-flight check.
---
