...
| `POST-001` | Update authoring | building | A short update, of a stated kind: an announcement, an achievement, or a progress note. Kinds exist because the three are read differently and an investor scanning for one should not have to read the other two |
